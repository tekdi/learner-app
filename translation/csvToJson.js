...
// This script lives in <repo>/translation, so the repo root is one level up.
// Deriving it (instead of hardcoding an absolute path) keeps the file portable
...
const TARGETS = [
  {
    ...
    csvPath: path.join(REPO_ROOT, 'translation', 'Pratham_ Translations - 20th July 2026 - Android App.csv'),
